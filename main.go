...
func main() {
	...
	checkMode := kp.Flag("", "С данным флагом приложение будет останавливаться в случае ошибок хотя бы в одном правиле, без этого флага \"плохие\" правила будут пропускаться").Bool()
